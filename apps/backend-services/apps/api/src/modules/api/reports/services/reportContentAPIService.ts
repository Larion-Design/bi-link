import { ReportContentModel } from '@app/entities/models/reports/reportContentModel'
import { LinkModel } from '@app/entities/models/reports/content/linkModel'
import { TableModel } from '@app/entities/models/reports/content/tableModel'
import { TextModel } from '@app/entities/models/reports/content/textModel'
import { TitleModel } from '@app/entities/models/reports/content/titleModel'
