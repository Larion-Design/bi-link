import { EventIndex, EventSearchIndex } from '@modules/definitions';
        ...
        request.query = {
          bool: {
            should: [
              ...
              this.searchHelperService.getMultisearchQuery<EventIndex>(
                searchTerm,
              ...
              this.searchHelperService.getConnectedPropertiesQuery(
                searchTerm,
                'properties',
              ),
